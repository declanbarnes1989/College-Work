...
//*****http://examples.javacodegeeks.com/android/android-barcode-and-qr-scanner-example/N*****//
            ...
            if (result != 0) {
                ...
                for (Symbol sym : syms) {
                  ...
                  /*  Toast.makeText(BarcodeScanner.this, scanResult,
                    ...
                    String rm = scanResult;
                    Bundle s = new Bundle();
                    s.putString("key", rm);
                    Intent i = new Intent(BarcodeScanner.this, Attend.class);
                    i.putExtras(s);
                    startActivity(i);
