 ...
 * @author Declan
 */
@WebServlet(urlPatterns = {"/alldvds"})
public class Alldvds extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try(PrintWriter out = response.getWriter()){
            ...
            String XMLFilePath = getServletContext().getRealPath("/data/video_store.xml");
            String XSLStyleSheetPath = getServletContext().getRealPath("/data/video_store.xsl");
            ...
            Logger.getLogger(Alldvds.class.getName()).log(Level.SEVERE, null, ex);
